...
## 3D models
Here you can find links to the 3D parts that I've designed in TinkerCAD. I'm using an Ultimaker 2 GO, which is a small printer, so these models should easily print on about any machine.
